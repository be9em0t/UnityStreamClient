...
namespace MocapiLiveStream
{
    ...
    public class FixedCam : MonoBehaviour
    {
        ...
        void GuiInput()
        {
            ...
            if (MocapiLiveStream.Gui.Up == true) { camPosY = camPosY + 0.1f; }
            if (MocapiLiveStream.Gui.Down == true) { camPosY = camPosY - 0.1f; }
            if (MocapiLiveStream.Gui.Left == true) { camPosX = camPosY + 0.1f; }
            if (MocapiLiveStream.Gui.Right == true) { camPosX = camPosY - 0.1f; }
